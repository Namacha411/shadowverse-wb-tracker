...
<form onsubmit={handleSubmit}>
	...
	<div class="field">
		...
		<textarea id="chosen" bind:value={chosenPlay} rows="2" placeholder="実際に選んだプレイ"></textarea>
	</div>

	<div class="field">
		<label for="alt">他択</label>
		<textarea id="alt" bind:value={alternatives} rows="2" placeholder="他に考えた選択肢"></textarea>
	</div>
